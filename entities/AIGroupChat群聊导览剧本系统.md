...
- [[AIGroupChat剧本生成系统]] — 剧本生成、Schema、configSet 组装与校验
- [[AIGroupChat运行时回复系统]] — 运行时插话回复、托住绕回、可见上下文边界
- [[AIGroupChat源数据与存储系统]] — 管理端数据读取、模板/剧本文件存储与发布
- [[技术文档结构化写作]] — 技术文档结构化写作
