...
| 层面 | 技术 |
|------|------|
| 深度学习框架 | [[PyTorch深度学习框架]] 2.4 (CUDA 12.4) |
...
4. 导出 COLMAP 格式或 PLY 点云供 [[3D摄影测量]] 工具链使用
...
- 与 [[3D摄影测量]] 共享 PLY 点云格式和 gsplat 渲染管线
- 与 [[AI图像生成工具链]] 同属腾讯混元 AI 生态
- 与 [[PyTorch深度学习框架]] 深度绑定，依赖 CUDA 加速推理
